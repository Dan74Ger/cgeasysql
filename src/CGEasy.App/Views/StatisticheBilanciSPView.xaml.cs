...
{
    public partial class StatisticheBilanciSPView : UserControl
    {
        private ViewModels.StatisticheBilanciSPViewModel? _viewModel;

        public StatisticheBilanciSPView()
        {
            InitializeComponent();
        ...
        {
            if (e.PropertyName == nameof(ViewModels.StatisticheBilanciSPViewModel.StatisticheMulti) ||
                e.PropertyName == nameof(ViewModels.StatisticheBilanciSPViewModel.PeriodiColonne))
            {
