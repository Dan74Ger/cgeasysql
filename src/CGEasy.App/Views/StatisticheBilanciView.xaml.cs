...
{
    public partial class StatisticheBilanciView : UserControl
    {
        private ViewModels.StatisticheBilanciViewModel? _viewModel;

        public StatisticheBilanciView()
        {
            InitializeComponent();
            
            var context = ((App)Application.Current).Services!.GetRequiredService<CGEasy.Core.Data.CGEasyDbContext>();
            _viewModel = new ViewModels.StatisticheBilanciViewModel(context);
        ...
        {
            if (e.PropertyName == nameof(ViewModels.StatisticheBilanciViewModel.StatisticheMulti) ||
                e.PropertyName == nameof(ViewModels.StatisticheBilanciViewModel.PeriodiColonne))
            {
